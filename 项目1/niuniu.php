...
//    echo '张子恒:  <br/>' . implode('  ', $card['user5']['cards']) . '<br /><br/>';
    ...
    for ($i = 1; $i <= 3; $i++) {
        if ($i == 1) {
            ...
            echo '张天明: <br/> ' . implode('  ', $a1) . '<br /><br/>';
            echo '彭震宇: <br/> ' . implode('  ', $b1) . '<br /><br/>';
...
//            echo $b1 . '<br/>';
        ...
        if ($i == 2) {
            ...
            echo '张天明: <br/> ' . implode('  ', $a2) . '<br /><br/>';
            echo '彭震宇:  <br/>' . implode('  ', $b2) . '<br /><br/>';

            echo '张天明: <br/>第二轮牌为： ' . implode('  ', $a) . '<br /><br/>';
            echo '彭震宇: <br/>第二轮牌为： ' . implode('  ', $b) . '<br /><br/>';
        ...
        if ($i == 3) {
            ...
            echo '张天明: <br/> ' . implode('  ', $a3) . '<br /><br/>';
            echo '彭震宇: <br/> ' . implode('  ', $b3) . '<br /><br/>';

            echo '张天明: <br/>最终牌为： ' . implode('  ', $a) . '<br /><br/>';
            echo '彭震宇: <br/>最终牌为： ' . implode('  ', $b) . '<br /><br/>';
